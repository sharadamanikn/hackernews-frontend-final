...
const NavigationBar = () => {
  ...
  return (
    <nav className="fixed top-1 left-0 right-0 z-50 bg-blue-950 hover:bg-pink-500 text-white border border-white-100 text-1xl font-sans max-w-screen-lg mx-auto  w-full rounded-md">
